...
//!===============================Device specific code hereabove==============================================================
        ...
        //! Top row left: timer 
        dc.setColor(mColourFont, Graphics.COLOR_TRANSPARENT);
        dc.drawText(xul, yul, Garminfont2, EstimatedTime(mTime*1000), Graphics.TEXT_JUSTIFY_CENTER|Graphics.TEXT_JUSTIFY_VCENTER);
        ...
        if (fieldformat.equals("0decimal" ) == true ) {
           dc.drawText(xbl, ybl, Garminfont2, fieldValue.format("%d"), Graphics.TEXT_JUSTIFY_CENTER|Graphics.TEXT_JUSTIFY_VCENTER);
        	...
        	dc.drawText(xbl, ybl, Garminfont2, EstimatedTime(fieldValue), Graphics.TEXT_JUSTIFY_CENTER|Graphics.TEXT_JUSTIFY_VCENTER);
        }
        ...
        if (fieldformat.equals("0decimal" ) == true ) {
           dc.drawText(xbr, ybr, Garminfont2, fieldValue.format("%d"), Graphics.TEXT_JUSTIFY_CENTER|Graphics.TEXT_JUSTIFY_VCENTER);        
        	...
        	dc.drawText(xbr, ybr, Garminfont2, EstimatedTime(fieldValue), Graphics.TEXT_JUSTIFY_CENTER|Graphics.TEXT_JUSTIFY_VCENTER);
        }
